...
int i=0,c;
FILE *fp;
double x, var, temp1=0.0, temp2=0.0;
...
//Defining function for generating random variables of the form 'V'

double v(char *str, int len)
{
int i=0,c;
FILE *fp1, *fp2;
double x, temp=0.0;
...
{
//Generating random numbers for'V'
temp = -2*log(1-x);
fprintf(fp1,"%lf\n",temp);
}
fclose(fp1);
...
//End of function for generating random variables of the form 'V'